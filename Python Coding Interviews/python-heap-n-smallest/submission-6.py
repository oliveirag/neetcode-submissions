...
def get_min_element(arr: List[int]) -> int:
    return heapq.nsmallest(1, arr)[0] # returns the smallest element in array
                                      # the [0] indexes the list to pull the actual value
...
def get_min_2_elements(arr: List[int]) -> List[int]:
    ...
    min_2 = heapq.nsmallest(2, arr) # make list with 4 smallest elements
    min_2.reverse # reverse list
    return min_2 # return the reversed list
